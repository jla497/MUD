...
std::unique_ptr<NonPlayerCharacter> YamlParser::parseNPC(YAML::Node npcNode){
    ...
    auto npc = std::make_unique<NonPlayerCharacter>(armor, damage, 
...
mudserver::gamemanager::EntityFactory* YamlParser::makeFactory() {
       mudserver::gamemanager::EntityFactory* factory = new mudserver::gamemanager::EntityFactory(getAllNPCS());
       return factory;
}
